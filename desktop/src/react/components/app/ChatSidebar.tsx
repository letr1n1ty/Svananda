...
import { HanaIconButton } from '../hana';
    ...
    <>
      <div className="sidebar-header">
        ...
        <div className="sidebar-header-actions">
          {isUiMigrationEnabled('sidebar.buttons') ? (
            <>
              <HanaIconButton title={t('sidebar.newChat')} onClick={onNewSession}>
              ...
              {showSettingsButton && (
                <HanaIconButton title={t('settings.title')} onClick={onOpenSettings}>
              ...
              <HanaIconButton title={t('sidebar.collapse')} onClick={onCollapse}>
