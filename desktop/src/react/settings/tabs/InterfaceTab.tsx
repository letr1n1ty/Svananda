        ...
        <div className={styles['theme-options']}>
          {VALID_THEMES.map(theme => {
            ...
            return (
              ...
              >
                <div className={styles['theme-card-name']} style={textColor ? { color: textColor } : undefined}>
                  {t(THEME_NAME_KEYS[theme])}
                </div>
                <div className={styles['theme-card-mode']} style={modeColor ? { color: modeColor } : undefined}>
                  {t(THEME_MODE_KEYS[theme])}
                </div>
              </button>
            );
          })}
